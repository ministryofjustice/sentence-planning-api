...
public class SentencePlanServiceTest {
    ...
    public void createSentencePlanShouldRetrieveOffenderAndAssessmentAndSavePlan() {
        ...
        when(assessmentService.getLatestAssessmentForOffender(offender)).thenReturn(assessment);
        ...
        verify(assessmentService,times(1)).getLatestAssessmentForOffender(offender);
    ...
    public void getSentencePlanShouldThrowNotFoundException() {
        ...
        assertThat(exception).isInstanceOf(ApplicationExceptions.EntityNotFoundException.class)
