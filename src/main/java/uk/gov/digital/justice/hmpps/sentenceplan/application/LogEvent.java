...
public enum LogEvent {
    ...
    SENTENCE_PLAN_OBJECTIVES_RETRIEVED,
    SENTENCE_PLAN_OBJECTIVE_CLOSED,
    SENTENCE_PLAN_OBJECTIVE_REOPENED,
    ...
    SENTENCE_BOARD_REVIEWS_RETRIEVED_OFFENDER,
