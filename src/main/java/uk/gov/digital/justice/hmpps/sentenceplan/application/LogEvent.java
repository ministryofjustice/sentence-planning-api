...
public enum LogEvent {
    ...
    SENTENCE_PLAN_STEPS_RETRIEVED,
    SENTENCE_PLAN_NEEDS_RETRIEVED,
    SENTENCE_PLAN_COMMENTS_CREATED,
    SENTENCE_PLAN_COMMENTS_RETRIEVED,
    SENTENCE_PLAN_STEP_CREATED,
    SENTENCE_PLAN_STARTED,
    SENTENCE_PLAN_STEP_RETRIEVED,
    SENTENCE_PLAN_MOTIVATIONS_UPDATED,
    SENTENCE_PLAN_STEP_UPDATED,
    SENTENCE_PLAN_STEP_PRIORITY_UPDATED, SENTENCE_PLANS_RETRIEVED;
