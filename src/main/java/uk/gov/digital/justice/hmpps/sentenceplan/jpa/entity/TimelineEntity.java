...
public class TimelineEntity implements Serializable {
    ...
    private TimelinePropertiesEntity payload;
    ...
    public TimelineEntity(UUID sentencePlanUUID, LogEvent type, String user, String from, String to) {
        this.uuid = UUID.randomUUID();
        this.sentencePlanUUID = sentencePlanUUID;
        this.payload = new TimelinePropertiesEntity(user, from, to);
